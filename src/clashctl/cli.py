...
from clashctl import __version__
from clashctl.config import default_config_path, load_config
from clashctl.tui import ClashCtlApp


def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="clashctl", description="TUI for the Clash proxy API"
    )
    p.add_argument(
        "-c",
        "--config",
